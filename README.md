# Excel to MySQL Automation Project
**Project Type:** Self-Directed / Independent Project  
...
## Skills Demonstrated
- Reading and processing Excel files with Python (`openpyxl`)
- SQL database interaction and automated inserts/updates (`mysql-connector-python`)
- Data cleaning, aggregation, and summarization
- Designing reusable, automated workflows
